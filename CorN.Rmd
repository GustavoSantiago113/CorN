...
<p style="text-align: justify; padding: 20px">The data used on this tool was gathered from several works developed by KSU personnel among different years and counties across Kansas. Using this tool, a farmer can know, based on their region, the economical and agronomic optimum doses for their corn. The agronomic optimum doses is obtained from the trials and the response of a quadratic plateau formula. The economical optimum doses is obtained from the agronomic optimum doses, combined with the price ratio inserted by the user.</p>
<!-- <p style="text-align: justify; padding: 20px">Above are the sources of the data used in this tool: </p> -->
<!-- <ul>Source</ul> -->
<!-- <ul>Source</ul> -->
<!-- <ul>Source</ul> -->
<!-- <ul>Source</ul> -->
